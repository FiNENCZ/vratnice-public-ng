...
@Component({
  selector: 'app-neaktivita',
  templateUrl: './neaktivita.page.html',
  styleUrls: ['./neaktivita.page.css']
})

export class NeaktivitaPage implements OnInit, OnDestroy {
  presmerovani = false;
  ...
  loginPage() {
    this.router.navigate(['login-sso']).then(() => {
  ...
  ngOnInit() {
    ...
    this.styleService.addStyle('main', this.styleNeaktivita());
  ...
  private styleNeaktivita(): string {
    return `html,
    body {
    /*   height: 100%; */
      height: 90%;
